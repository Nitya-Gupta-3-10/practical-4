...
create table medical_record(record_id int primary key,patient_id int,doctor_id int,diagnosis varchar(60),prescription varchar(80),visit_date varchar(60),foreign key (doctor_id) references doctor(doctor_id), foreign key (patient_id) references patient(patient_id)) ;
